...
@store1.employees.create(first_name: "Jun", last_name: "Im", hourly_rate: 50)
...
@store1.employees.create(first_name: "Yireh", last_name: "Yun", hourly_rate: 50)
@store2.employees.create(first_name: "Inseoup", last_name: "Yun", hourly_rate: 51)
